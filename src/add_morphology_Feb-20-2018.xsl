...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="word">
        ...
        <word>
            ...
            <xsl:attribute name="self-parentOrder"><xsl:value-of select="./@Parent_Order"/></xsl:attribute>
            <xsl:attribute name="self-hasSib"><xsl:value-of select="./@Has_Sib"/></xsl:attribute>
            
            
            <xsl:choose>
                <xsl:when test="(./@Degree = 'NA') or (./@Degree = 'NULL')">
                    <xsl:attribute name="self-isParent">NA</xsl:attribute>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:choose>
                        <xsl:when test="./@Degree > 0">
                            <xsl:attribute name="self-isParent">true</xsl:attribute>
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:attribute name="self-isParent">false</xsl:attribute>
                        </xsl:otherwise>
                    </xsl:choose>
                </xsl:otherwise>
            </xsl:choose>
            ...
            <xsl:choose>
                <xsl:when test="(./@Node_Depth = 'NA') or (./@Node_Depth = 'NULL')">
                    <xsl:attribute name="self-hasG1parent">false</xsl:attribute>
                    <xsl:attribute name="self-hasG2parent">false</xsl:attribute>
                    <xsl:attribute name="self-hasG3parent">false</xsl:attribute>
                    <xsl:attribute name="self-hasG4parent">false</xsl:attribute>
                    <xsl:attribute name="self-hasG5parent">false</xsl:attribute>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:choose>
                        <xsl:when test="./@Node_Depth >= 2">
                            <xsl:attribute name="self-hasG1parent">true</xsl:attribute>
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:attribute name="self-hasG1parent">false</xsl:attribute>
                        </xsl:otherwise>
                    ...
                    <xsl:choose>
                        <xsl:when test="./@Node_Depth >= 3">
                            <xsl:attribute name="self-hasG2parent">true</xsl:attribute>
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:attribute name="self-hasG2parent">false</xsl:attribute>
                        </xsl:otherwise>
                    ...
                    <xsl:choose>
                        <xsl:when test="./@Node_Depth >= 4">
                            <xsl:attribute name="self-hasG3parent">true</xsl:attribute>
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:attribute name="self-hasG3parent">false</xsl:attribute>
                        </xsl:otherwise>
                    ...
                    <xsl:choose>
                        <xsl:when test="./@Node_Depth >= 5">
                            <xsl:attribute name="self-hasG4parent">true</xsl:attribute>
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:attribute name="self-hasG4parent">false</xsl:attribute>
                        </xsl:otherwise>
                    ...
                    <xsl:choose>
                        <xsl:when test="./@Node_Depth >= 6">
                            <xsl:attribute name="self-hasG5parent">true</xsl:attribute>
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:attribute name="self-hasG5parent">false</xsl:attribute>
                        </xsl:otherwise>
            ...
            <xsl:choose>
                <xsl:when test="$parent_id = 0">
                    ...
                    <xsl:attribute name="parent-parentOrder">NULL</xsl:attribute>
                    <xsl:attribute name="parent-hasSib">NULL</xsl:attribute>
                ...
                <xsl:when test="$parent_id > 0">
                    ...
                    <xsl:attribute name="parent-parentOrder"><xsl:value-of select="../word[@id = $parent_id]/@Parent_Order"/></xsl:attribute>
                    <xsl:attribute name="parent-hasSib"><xsl:value-of select="../word[@id = $parent_id]/@Has_Sib"/></xsl:attribute>
            ...
            <xsl:variable name="g1-parent-degree" select="substring(../word[@id = $g1-parent_id]/@postag, 9, 1)"/>
             ...
             <xsl:choose>
                 <xsl:when test="$g1-parent_id = 0">
                     ...
                     <xsl:attribute name="g1-parent-parentOrder">NULL</xsl:attribute>
                     <xsl:attribute name="g1-parent-hasSib">NULL</xsl:attribute>
                 ...
                 <xsl:when test="$g1-parent_id > 0">
                     ...
                     <xsl:attribute name="g1-parent-parentOrder"><xsl:value-of select="../word[@id = $g1-parent_id]/@Parent_Order"/></xsl:attribute>
                     <xsl:attribute name="g1-parent-hasSib"><xsl:value-of select="../word[@id = $g1-parent_id]/@Has_Sib"/></xsl:attribute>
                     ...
                     <xsl:choose>
                         ...
                         <xsl:when test="$g1-parent-mood='m'">
                             <xsl:attribute name="g1-parent-morph-mood">imperative</xsl:attribute>
                         </xsl:when>
                         <xsl:otherwise>
            ...
            <xsl:choose>
                <xsl:when test="$g2-parent_id = 0">
                    ...
                    <xsl:attribute name="g2-parent-parentOrder">NULL</xsl:attribute>
                    <xsl:attribute name="g2-parent-hasSib">NULL</xsl:attribute>
                ...
                <xsl:when test="$g2-parent_id > 0">
                    ...
                    <xsl:attribute name="g2-parent-parentOrder"><xsl:value-of select="../word[@id = $g2-parent_id]/@Parent_Order"/></xsl:attribute>
                    <xsl:attribute name="g2-parent-hasSib"><xsl:value-of select="../word[@id = $g2-parent_id]/@Has_Sib"/></xsl:attribute>
            ...
            <xsl:choose>
                <xsl:when test="$g3-parent_id = 0">
                    ...
                    <xsl:attribute name="g3-parent-parentOrder">NULL</xsl:attribute>
                    <xsl:attribute name="g3-parent-hasSib">NULL</xsl:attribute>
                ...
                <xsl:when test="$g3-parent_id > 0">
                    ...
                    <xsl:attribute name="g3-parent-parentOrder"><xsl:value-of select="../word[@id = $g3-parent_id]/@Parent_Order"/></xsl:attribute>
                    <xsl:attribute name="g3-parent-hasSib"><xsl:value-of select="../word[@id = $g3-parent_id]/@Has_Sib"/></xsl:attribute>
            ...
            <xsl:choose>
                <xsl:when test="$g4-parent_id = 0">
                    ...
                    <xsl:attribute name="g4-parent-parentOrder">NULL</xsl:attribute>
                    <xsl:attribute name="g4-parent-hasSib">NULL</xsl:attribute>
                </xsl:when>
                <xsl:when test="$g4-parent_id > 0">
                    ...
                    <xsl:attribute name="g4-parent-parentOrder"><xsl:value-of select="../word[@id = $g4-parent_id]/@Parent_Order"/></xsl:attribute>
                    <xsl:attribute name="g4-parent-hasSib"><xsl:value-of select="../word[@id = $g4-parent_id]/@HasSib"/></xsl:attribute>
