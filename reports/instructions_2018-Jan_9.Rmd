...
* **node.list$Degree <- sapply(sent_working, extract_degree)** populates the appropriate list item in **node.list** with a numerical vector of vertex degree for each token in the sentence. **sapply()** applies the user-defined function, **extract_degree()**, to each token in the input argument, **sent_working.**
